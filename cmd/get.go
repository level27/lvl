...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("get domains called")
		level27Client.DomainGet(args)
	},
}
...
func init() {
	...
	getCmd.PersistentFlags().StringVarP(&optNumber, "number", "n", optNumber, "How many domains should we retrieve from the API?")
